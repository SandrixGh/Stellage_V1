...
export const MOCK_TEMPLATES: BoxTemplate[] = [
    t("1",  "Sunset Collection",   "Коллекция закатных фотографий в высоком разрешении",        "29.99",  "usd", "Golden",      "photo"),
    t("2",  "Base Template",       "Стартовый набор для каждого пользователя",                  "0",      "usd", "Common",      "hybrid"),
    t("3",  "Rare Artifacts",      "Редкие артефакты и исторические находки",                   "99.99",  "usd", "Rare",        "photo"),
    t("4",  "Developer's Kit",     "Специальный набор инструментов для разработчиков",          "199.99", "usd", "Developer's", "app"),
    t("5",  "Cosmic Dreams",       "Визуальное путешествие через космос",                       "49.99",  "usd", "Golden",      "video"),
    t("6",  "Urban Sketches",      "Набор городских зарисовок и архитектурных этюдов",          "19.99",  "usd", "Common",      "photo"),
    t("7",  "Nature's Wonders",    "Самые красивые уголки дикой природы планеты",               "74.99",  "usd", "Rare",        "photo"),
    t("8",  "Golden Age",          "Исторические золотые эпохи цивилизации",                    "149.99", "usd", "Golden",      "photo"),
    t("9",  "Sound Waves",         "Эксклюзивные звуковые текстуры и аудио-арт",                "12.99",  "usd", "Common",      "file"),
    t("10", "Pixel Legends",       "Пиксельные иллюстрации в ретро-стиле",                      "39.99",  "eur", "Rare",        "photo"),
    t("11", "Aurora Bundle",       "Северное сияние — пейзажи и абстракции",                    "89.99",  "usd", "Golden",      "photo"),
    t("12", "Code Scrolls",        "Редкие алгоритмы и программные артефакты",                  "299.00", "usd", "Developer's", "script"),
    t("13", "Street Art Pack",     "Граффити и муралы ведущих городских художников",            "0",      "usd", "Common",      "photo"),
    t("14", "Deep Sea",            "Биолюминесцентные существа абиссальных глубин",             "64.99",  "usd", "Rare",        "photo"),
    t("15", "Alchemist's Vault",   "Секретные формулы и схемы средневековых алхимиков",         "124.99", "gbp", "Golden",      "text"),
    t("16", "Glitch Lab",          "Экспериментальные глитч-арт текстуры",                      "9.99",   "usd", "Common",      "video"),
    t("17", "Nebula Series",       "Туманности и звёздные скопления в высоком разрешении",       "54.99",  "usd", "Rare",        "photo"),
    t("18", "Open Source Kit",     "Открытые инструменты для разработки и деплоя",              "0",      "usd", "Developer's", "script"),
    t("19", "Wabi-Sabi",           "Японская эстетика несовершенства и мимолётности",           "34.99",  "jpy", "Common",      "photo"),
    t("20", "Crown Jewels",        "Ультра-редкая коллекция цифровых сокровищ",                 "499.99", "usd", "Golden",      "photo"),
    t("21", "Neon Districts",      "Киберпанк-город в неоновом свечении",                       "44.99",  "usd", "Rare",        "video"),
    t("22", "Field Notes",         "Минималистичные заметки и наброски",                        "4.99",   "usd", "Common",      "text"),
    t("23", "Quantum Toolkit",     "Экспериментальные квантовые алгоритмы",                     "349.99", "usd", "Developer's", "app"),
    t("24", "Marble Halls",        "Архитектура классических мраморных интерьеров",             "79.99",  "eur", "Golden",      "photo"),
    t("25", "Lo-Fi Tapes",         "Тёплые ламповые звуки и зацикленные биты",                  "14.99",  "usd", "Common",      "file"),
    t("26", "Frostbite",           "Макросъёмка льда и зимних кристаллов",                      "59.99",  "usd", "Rare",        "photo"),
    t("27", "Solar Flare",         "Снимки солнечной короны и протуберанцев",                   "169.99", "usd", "Golden",      "photo"),
    t("28", "Daily Doodles",       "Повседневные дудлы и быстрые скетчи",                       "0",      "usd", "Common",      "text"),
    t("29", "Tide Pools",          "Жизнь прибрежных приливных бассейнов",                      "47.50",  "usd", "Rare",        "photo"),
    t("30", "Compiler Secrets",    "Редкие приёмы оптимизации компиляторов",                    "279.00", "usd", "Developer's", "script"),
    t("31", "Velvet Hours",        "Атмосферная вечерняя фотография в тёплых тонах",             "109.99", "usd", "Golden",      "photo"),
    t("32", "Paper Textures",      "Набор бумажных и картонных текстур",                        "7.99",   "usd", "Common",      "photo"),
    t("33", "Storm Front",         "Драматичные кадры гроз и штормового неба",                  "69.99",  "usd", "Rare",        "photo"),
    t("34", "Royal Archive",       "Цифровая реконструкция королевских регалий",                "459.99", "gbp", "Golden",      "photo"),
    t("35", "Shader Garden",       "Коллекция процедурных шейдеров и эффектов",                 "229.99", "usd", "Developer's", "script"),
    t("36", "Botanica",            "Гербарий и ботанические иллюстрации в винтажном стиле",      "16.99",  "usd", "Common",      "photo"),
    t("37", "Ghost Frequencies",   "Эфирные эмбиент-текстуры и полевые записи",                 "57.99",  "eur", "Rare",        "file"),
    t("38", "Amber Vault",         "Янтарные реликвии и окаменелости древних эпох",             "189.99", "usd", "Golden",      "photo"),
    t("39", "Kernel Panic",        "Низкоуровневые системные хаки и драйверы",                  "319.00", "usd", "Developer's", "script"),
    t("40", "Concrete Poems",      "Типографские эксперименты и конкретная поэзия",             "8.49",   "usd", "Common",      "text"),
    t("41", "Migratory",           "Маршруты перелётных птиц в инфографике и фото",             "62.50",  "usd", "Rare",        "hybrid"),
    t("42", "Gilded Frames",       "Золочёные рамы и детали барочных интерьеров",               "144.99", "gbp", "Golden",      "photo"),
    t("43", "Async Rituals",       "Паттерны конкурентного программирования",                   "264.99", "usd", "Developer's", "script"),
    t("44", "Ferro Dreams",        "Феррожидкости и магнитные скульптуры в движении",           "73.99",  "usd", "Rare",        "video"),
    t("45", "Tin Toys",            "Коллекция жестяных игрушек середины века",                  "0",      "usd", "Common",      "photo"),
];
